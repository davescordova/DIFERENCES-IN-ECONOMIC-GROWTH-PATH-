clear all
import excel "C:\Users\daves\OneDrive\Pessoal\Acadêmico\Mestrado\Dissertação - Execução\Análises\Dados do Censo - não usar na regressão\População total.xlsx", sheet("Planilha2") firstrow clear
//População total
xtset Code Year
xtset Code Year
...
//exportar para jpg
graph export "C:/Users/daves/OneDrive/Pessoal/Acadêmico/Mestrado/Dissertação - Execução/Dissertação/Quadros e gráficos/Graph10.jpg", as(jpg) replace width(4000) height(3000)